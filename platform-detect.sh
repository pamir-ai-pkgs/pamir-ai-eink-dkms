...
# Platform detection helper script for Pamir AI E-Ink DKMS
...
get_overlay_name() {
	...
	# E-ink uses same overlay name across all platforms
	echo "pamir-ai-eink"
}
...
get_dts_file() {
	...
	# E-ink uses single overlay for all platforms currently
	echo "pamir-ai-eink-overlay.dts"
}
